...
let abi = require("../json/TToken.json").abi;
let contract = new web3.eth.Contract(abi, "0x1EF4a073b848Ae730eE1397e3b73B83Daf3Be7C0");
if (undefined == contract) {
    console.log("un");
    return;
}

// myContract.getPastEvents('PairCreated', {
//     fromBlock: 0,
//     toBlock: 'latest'
...
//     address: '0x54e92B8C0a7Ea8DE6404A0F43DA1a90398467E63'
