...
const REDEEM = "0x3d3eb386130698320318C8EF39f3a119b65FDAc7";//"0x7416DB6a1021e61cdA12dce8cE99d14c21D2d379";//Redeem.methods.address;
...
////step 2
let abi = require("../json/MerkleRedeem.json").abi;///Users/lisheng/Downloads/defi/balancer/balancer-core-master/build/contracts/BFactory.json
...
amt1 = await TToken.methods.symbol().call({ from: admin3 });
    ...
    // await Redeem.methods.finishEpoch(1, epoch1Block.timestamp, epoch1Block.hash).send({ from: admin3});  
    // await Redeem.methods.seedAllocations(1, root1).send({ from: admin3 });
